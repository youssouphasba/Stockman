        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalScroll}>
              ...
              <TextInput style={styles.input} value={formCategory} onChangeText={setFormCategory} placeholder="Ex: Alimentaire, Cosmétique..." placeholderTextColor={Colors.textMuted} />
