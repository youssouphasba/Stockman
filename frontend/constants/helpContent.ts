...
export const HELP_MODULES: HelpModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: 'storefront-outline', title: "Site e-commerce", description: "Stockman prépare un site public désactivé par défaut. L'administrateur peut l'activer, choisir la boutique liée, personnaliser le nom du site, l'accueil, la livraison, WhatsApp, le paiement manuel et configurer le domaine. Le format recommandé pour un domaine connecté est www.votredomaine.com : créez un CNAME vers Stockman, puis redirigez votredomaine.com vers ce sous-domaine. Les couleurs se choisissent avec des pastilles visuelles. Le bouton E-com permet de voir le site, d'ouvrir les statistiques et d'accéder aux paramètres. Les commandes E-com arrivent dans Stockman avec notifications push, in-app et e-mail, les coordonnées client alimentent automatiquement le CRM, et les commandes livrées sont comptées comme des ventes, pas comme des pertes." },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: 'notifications-outline', title: "Alertes et rappels", description: "Choisissez les canaux d'alerte, les destinataires utiles, les seuils et lancez une notification de test pour verifier le branchement push. Si Expo ou FCM sont mal configures, le test affiche maintenant l'erreur reelle au lieu d'un faux succes. Les alertes stock tres proches pour un meme produit sont aussi regroupees pour reduire le bruit." },
