...
export const HELP_MODULES: HelpModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: 'notifications-outline', title: "Alertes et rappels", description: "Choisissez les canaux d'alerte, les destinataires utiles, les seuils et lancez une notification de test pour verifier le branchement push. Si Expo ou FCM sont mal configures, le test affiche maintenant l'erreur reelle au lieu d'un faux succes." },
