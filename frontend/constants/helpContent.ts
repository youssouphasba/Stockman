...
export const HELP_MODULES: HelpModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: 'card-outline', title: "Abonnement et facturation", description: "Consultez votre formule actuelle, comparez les autres offres et relisez les reglages lies au renouvellement. Les plans Starter et Pro se gerent surtout sur mobile, tandis que le passage a Enterprise se confirme sur le web sans recreer le compte." },
