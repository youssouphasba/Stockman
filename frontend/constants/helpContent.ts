...
export const HELP_MODULES: HelpModule[] = [
  ...
  },
  {
    ...
    audience: 'all',
    features: [
      { icon: 'person-outline', title: "Compte et application", description: "Réglez ici l'apparence, la langue, les préférences de compte et les options liées à votre appareil." },
      ...
      { icon: 'notifications-outline', title: "Alertes et rappels", description: "Choisissez les canaux d'alerte, les destinataires utiles et les règles automatiques importantes." },
      { icon: 'card-outline', title: "Abonnement et facturation", description: "Consultez votre formule, le contact de facturation et les réglages liés au renouvellement." },
      ...
      { icon: 'help-circle-outline', title: "Aide et support", description: "Le centre d'aide, l'assistant et le contact support sont regroupés au même endroit." },
      { icon: 'warning-outline', title: "Signaler un problème", description: "Utilisez ce formulaire quand vous devez remonter un incident ou une anomalie importante." },
