...
export const HELP_MODULES: HelpModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: 'storefront-outline', title: "Site e-commerce", description: "Stockman prépare un site public désactivé par défaut. L'administrateur peut l'activer, choisir la boutique liée, personnaliser le nom du site, l'accueil, la livraison, WhatsApp, le paiement manuel et configurer le domaine : garder le domaine Stockman, connecter un domaine déjà acheté ou demander de l'aide pour choisir et brancher un domaine externe. Les couleurs se choisissent avec des pastilles visuelles. Le bouton E-com permet de voir le site, d'ouvrir les statistiques et d'accéder aux paramètres. Les commandes E-com arrivent dans Stockman avec notifications push, in-app et e-mail, et les coordonnées client alimentent automatiquement le CRM." },
