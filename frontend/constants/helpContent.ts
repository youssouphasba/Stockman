...
export const HELP_MODULES: HelpModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: 'sync-outline', title: "Synchronisation", description: "Vérifiez l'état de connexion, les actions en attente et les modules compatibles hors ligne. Les ventes, écritures compatibles, clients et paiements clients sont renvoyés automatiquement dès le retour du réseau." },
