...
export const HELP_MODULES: HelpModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: 'storefront-outline', title: "Site e-commerce", description: "Stockman prépare un site public désactivé par défaut. L'administrateur peut l'activer, choisir la boutique liée, personnaliser le nom du site, l'accueil, la livraison, WhatsApp, le paiement manuel et ajouter un domaine personnalisé. Le bouton E-com permet de voir le site, d'ouvrir les statistiques et d'accéder aux paramètres. Les statistiques suivent les visites publiques, les ajouts au panier, les commandes, la conversion et les produits les plus ajoutés au panier. Le commerçant peut choisir d'afficher les produits en rupture ; ils restent visibles mais non commandables. Les commandes E-com arrivent dans Stockman avec notifications push, in-app et e-mail, et les coordonnées client alimentent automatiquement le CRM." },
