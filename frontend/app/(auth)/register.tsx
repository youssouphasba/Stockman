...
export default function RegisterScreen() {
  ...
  const authText = {
    ...
    shopkeeper: t('auth.register.shopkeeper', 'Commerçant'),
    shopkeeperAccount: t('auth.register.shopkeeperAccount', 'Compte commerçant'),
    shopkeeperDesc: t('auth.register.shopkeeperDesc', 'Gérez vos stocks et commandez auprès de fournisseurs.'),
    supplier: t('auth.register.supplier', 'Fournisseur'),
    supplierAccount: t('auth.register.supplierAccount', 'Compte fournisseur'),
    supplierDesc: t('auth.register.supplierDesc', 'Publiez votre catalogue et recevez des commandes.'),
    alreadyHaveAccount: t('auth.register.alreadyHaveAccount', 'Déjà un compte ?'),
    name: t('auth.register.name', 'Nom'),
    namePlaceholder: t('auth.register.namePlaceholder', 'Votre nom'),
    countryCurrency: t('auth.register.countryCurrency', 'Pays et devise'),
    phone: t('auth.register.phone', 'Téléphone'),
    phonePlaceholder: t('auth.register.phonePlaceholder', 'Numéro local'),
    email: t('auth.register.email', 'Email'),
    password: t('auth.register.password', 'Mot de passe'),
    passwordPlaceholder: t('auth.register.passwordPlaceholder', 'Minimum 8 caractères'),
    confirmPassword: t('auth.register.confirmPassword', 'Confirmer le mot de passe'),
    confirmPasswordPlaceholder: t('auth.register.confirmPasswordPlaceholder', 'Confirmez votre mot de passe'),
    continue: t('auth.register.continue', 'Continuer'),
    businessType: t('auth.register.businessType', "Secteur d'activité"),
    selectBusinessType: t('auth.register.selectBusinessType', 'Choisissez un secteur'),
    howDidYouHear: t('auth.register.howDidYouHear', 'Comment avez-vous connu Stockman ?'),
    howDidYouHearPlaceholder: t('auth.register.howDidYouHearPlaceholder', 'Ex. : Facebook, ami, client, Google'),
    createAccount: t('auth.register.createAccount', 'Créer mon compte'),
    trialNote: t('auth.register.trialNote', '30 jours gratuits • Sans carte bancaire'),
    errorFillRequired: t('auth.register.errorFillRequired', 'Veuillez remplir tous les champs obligatoires.'),
    errorSelectSector: t('auth.register.errorSelectSector', "Veuillez sélectionner votre secteur d'activité."),
    errorPasswordLength: t('auth.register.errorPasswordLength', 'Le mot de passe doit contenir au moins 8 caractères.'),
    errorPasswordsMismatch: t('auth.register.errorPasswordsMismatch', 'Les mots de passe ne correspondent pas.'),
    errorTerms: t('auth.register.errorTerms', 'Veuillez accepter les CGU et la Politique de confidentialité.'),
    acceptTerms: t('auth.register.acceptTerms', "J'accepte les"),
    acceptPrivacy: t('auth.register.acceptPrivacy', "J'accepte la"),
    changeProfile: t('auth.register.changeProfile', 'Changer de profil'),
  };
